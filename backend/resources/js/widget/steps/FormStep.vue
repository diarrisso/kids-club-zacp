...
<template>
    <form @submit.prevent="advance">
        ...
        <div v-if="selection.slot"
             class="mt-4 flex items-center gap-3 rounded-2xl px-4 py-3.5 ring-1 ring-[#5A7A91]/20"
            ...
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500">{{ recapDate }} · {{ recapTime }}</p>
            </div>
        </div>
        ...
        <fieldset class="mt-5 rounded-2xl bg-[#F8FAFB] p-4 ring-1 ring-slate-100/80">
            <legend class="flex items-center gap-2 px-1">
                ...
                <span class="text-[11px] font-bold uppercase tracking-[0.15em] text-slate-500">Elternteil</span>
            </legend>
